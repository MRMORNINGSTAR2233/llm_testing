...
class ChainOfThoughtDataset(Dataset):
    def __init__(self, hf_dataset, tokenizer, max_length: int = 1024, split="train"):
...
def prepare_dataset(tokenizer, batch_size=4, train_subset_ratio=0.1):
...
# Main execution
def main():
    base_model_name = "gpt2-medium"  # Using a smaller model for faster training
